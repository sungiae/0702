 ...
 *		5-2 재사용 (언제 상속 or 포함 쓰는지)
 *		5-3 유지 보수 (추가, 수정) => 오버로딩 / 오버라이딩
 *			 메소드 => 제어자 사용여부 (static, abstract, final)
 *					 메소드에 final 사용 => 오버라이딩 (수정) 불가 => 고정
 *		class :
 *			= 부품 (Component) ==> 게시판, 예매, 목록, 영화 상세보기
 *			= 조립자 (Container) => Spring
 *			=> main()
 *		===========================================================
 *		 클래스 : 패키지와 상관없이 모든 클래스에서 사용이 가능하게 만든다 => 특별한 경우가 아니라면 public
 *		===========================================================
 *		 메소드 : 다른 클래스와 연결하기 위한 목적 : public
 *		===========================================================
 *		 변수 : 다른 클래스에 직접 사용이 불가능하게 만든다 : private
 *		===========================================================
 *		 생성자 : 다른 클래스에 클래스를 저장해서 사용 => 호출이 가능하게 만든다 : public
 *		===========================================================
 *	6. 상속, 포함 => 클래스의 크기 확인
 *				   is-a => 상위 클래스 > 하위 클래스
 *				   has-a => 가지고 있는 클래스가 크다
 *		class A
 *		class B extends A
 *
 *		==> A a=new A();
 ...
 *                        
 *		===============================================================================
 *		= 내부 클래스 : 다른 클래스에서 변수, 메소드의 접근이 쉽게 만들어 주는 역할의 클래스
 *			= 멤버클래스 => 쓰레드, 네트워크
 *            {
 *            	 class B
 *            	 {
...
public class 클래스의종류 {
	...
	public static void main(String[] args) {
		...
		if(s instanceof Object) // Object > String    true
			System.out.println("true");
		else
			System.out.println("false");
		
		if(obj instanceof String) // Object < String  false
			System.out.println("true");
		else
			System.out.println("false");
...
//		if(s instanceof StringBuffer) { // 비교할 수 없는 대상을 비교해서 오류
//			System.out.println("true");
//		}
	}
