 ...
 *           }
 *           
 *           ==> 인터페이스는 미완성 이기 때문에 => 상속을 내려서 구현한 다음에 사용
 *                                                      =========
 ...
 *                       =======   ================ // extends, implements 같이 나올 수 있다
 */
import javax.swing.*;
interface A
{
	int a=10; // 상수형이므로 반드시 초기값 설정 / int a; => 오류
	void display();
}
class B implements A{
	public void display() {}
}
public class 인터페이스 extends JFrame implements MouseListener, KeyListener, ActionListener, FocusListener, Runnable {
